...
namespace Blog.Platform2.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> EditUsers()
        {
            ...
            List<ApplicationUser> standardUsers = new List<ApplicationUser>();
        ...
        public async Task<ActionResult> Delete(string id)
        {
            ...
            // Todo: Also remove associated blogs. Currently still persist.
        }
